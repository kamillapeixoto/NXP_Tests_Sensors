...
MODEL                = Pressure_I2C_BMP388_2
MODULES              = Pressure_I2C_BMP388_2_data.c mbd_main.c clock_S32K1xx.c edma_driver.c edma_hw_access.c edma_irq.c interrupt_manager.c lpi2c_driver.c lpi2c_hw_access.c lpi2c_irq.c lpit_driver.c osif_baremetal.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K144.c
MAKEFILE             = Pressure_I2C_BMP388_2.mk
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\Pressure_I2C_BMP388_2_mbd_rtw \
