...
MODEL                = Pressure_SPI_BMP388
MODULES              = Pressure_SPI_BMP388_data.c mbd_main.c clock_S32K1xx.c edma_driver.c edma_hw_access.c edma_irq.c interrupt_manager.c lpit_driver.c lpspi_hw_access.c lpspi_irq.c lpspi_master_driver.c lpspi_shared_function.c lpspi_slave_driver.c osif_baremetal.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K144.c
MAKEFILE             = Pressure_SPI_BMP388.mk
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\Pressure_SPI_BMP388_mbd_rtw \
