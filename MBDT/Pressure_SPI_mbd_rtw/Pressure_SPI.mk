...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\Pressure_SPI_mbd_rtw \
...
%.o : C:\Users\kamil\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~1\MBDTBX~1\blocks\lpspi/%.c
	@echo ### "C:\Users\kamil\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~1\MBDTBX~1\blocks\lpspi\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
