...
MODEL                = Pressure_I2C
MODULES              = freemaster_interface_init.c ftm0_pwm_params.c mbd_main.c adc_driver.c clock_S32K1xx.c edma_driver.c edma_hw_access.c edma_irq.c freemaster_S32K1xx.c freemaster_appcmd.c freemaster_protocol.c freemaster_rec.c freemaster_scope.c freemaster_serial.c freemaster_sfio.c freemaster_tsa.c ftm_chn_irq.c ftm_common.c ftm_fault_irq.c ftm_hw_access.c ftm_ic_driver.c ftm_mc_driver.c ftm_oc_driver.c ftm_pwm_driver.c ftm_qd_driver.c interrupt_manager.c lin_common.c lin_driver.c lin_irq.c lin_lpuart_driver.c lpi2c_driver.c lpi2c_hw_access.c lpi2c_irq.c lpit_driver.c lpuart_driver.c lpuart_hw_access.c lpuart_irq.c mbd_adc_irq.c osif_baremetal.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K144.c
MAKEFILE             = Pressure_I2C.mk
MATLAB_ROOT          = C:\Program Files\MATLAB\R2022b
ALT_MATLAB_ROOT      = C:\PROGRA~1\MATLAB\R2022b
START_DIR            = C:\Users\kamil\OneDrive\Documents\GitHub\NXP_Tests_Scaleo
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 1
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\Pressure_I2C_mbd_rtw \
...
###################################
%.o : C:\Users\kamil\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~1\MBDTBX~1\blocks\adc/%.c
	@echo ### "C:\Users\kamil\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~1\MBDTBX~1\blocks\adc\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\Users\kamil\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~1\MBDTBX~1\blocks\lpi2c/%.c
	@echo ### "C:\Users\kamil\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~1\MBDTBX~1\blocks\lpi2c\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\Users\kamil\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~1\MBDTBX~1\blocks\ftm/%.c
	@echo ### "C:\Users\kamil\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~1\MBDTBX~1\blocks\ftm\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\Users\kamil\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~1\MBDTBX~1\blocks\fm/%.c
	@echo ### "C:\Users\kamil\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~1\MBDTBX~1\blocks\fm\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
